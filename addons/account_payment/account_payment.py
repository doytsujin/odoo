...
class payment_order(osv.osv):
    ...
    _columns = {
        ...
        'total': fields.function(_total, string="Total", type='float', store=True),
        'user_id': fields.many2one('res.users', 'Responsible', required=True, states={'done': [('readonly', True)]}, store=True),
